  ...
  return (
    <div className=" py-20 container m-auto">
      ...
      <section id="Course" className="grid justify-center items-center">
        ...
        <div className=" w-full !grid grid-cols-1 md:!grid-cols-2 lg:!grid-cols-3 xl:!grid-cols-4 gap-2 md:!gap-3 py-3  mt-5 justify-center">
          {loading
      ...
      <section id="Feedback" className="divide-y-4 divide-green-200">
        <span className="text-[40px] font-bold flex justify-center items-center mt-8 text_theme divide-y divide-yellow-300 ">
          Student{" "}
          <span className="ml-3 text-coching-text_color"> Feedback</span>
        </span>

      ...
      <section className="bg-0">
        <div className="container  py-6 ">
          <section className="grid grid-cols-3 gap-4 transition-all lg:gap-8">
            ...
            <div className={`${theme==="light"?"bg-[#F8FAFC] border-white":"bg-slate-900"} border-light-1 shadow-1 col-span-full h-max rounded-md border pb-1 border-gray-800 dark:border-slate-50/[0.06] dark:bg-slate-900 lg:col-span-1 lg:rounded-lg`}>
              <div className="sticky top-0 z-10 rounded-t-md  p-3  dark:bg-slate-900 lg:rounded-t-lg">
                <div className="flex flex-1 items-center justify-center">
                  <div className=" w-full">
                    <div className="mantine-TextInput-wrapper mantine-12sbrde">
                      <div className={`${theme==="light"?"bg-[#F8FAFC] border rounded-md p-1 text-black":"bg-[#1E293B] rounded-md p-1"} flex items-center pl-2  `}>
                        <IoSearchOutline color={`${theme==="light"?"black":"white"}`} size={20} />
                        <input
                          type="text"
                          className={`${theme==="light"?"bg-[#F8FAFC] text-black":"bg-[#1E293B]"} mantine-9sfq4p`}
              ...
              <div className={`flow-root px-4 py-2 ${theme==="light"?"bg-white ":"bg-slate-900 border-gray-800 "} dark:bg-slate-900 border-t  `}>
                <div className="mantine-ScrollArea-root h-max lg:h-[calc(100vh_-_250px)] mantine-jghxib content_container">
                  {videoData.map((data) => (
                    <div
                      key={data.id}
                      className={`lg:w-full border-b ${theme==="light"?"border-gray-300":"border-gray-800"} `}
                    >
                      <div
                        className="flex transition pt-3 hover:bg-gray-400  duration-300 ease-in-out lg:pt-4 lg:pl-2 pr-3 pb-4 justify-start cursor-pointer gap-5 lg:items-start"
                      ...
                      >
                        ...
                        <div className="flex flex-col items-start">
                          <div>
                            <h3
                              className={`${theme==="light"?"text-[#000]":"text-[#94A3BB]"} mantine-hgwlez text-xs lg:text-sm `}
                              style={{
                                color:
                                  Openvisible && Previewid === data.id
                                    ? "white"
                          ...
                          <div>
                            <div
                              className={`lg:flex lg:gap-3 text-[12px] ${theme==="light"?"text-[#504f4f]":"text-[#94A3BB]"} hidden `}
                              style={{
                                color:
                                  Openvisible && Previewid === data.id
                                    ? "white"

...
function Enrollment() {
  ...
  return (
    <>
      ...
      {/* <section className={`wrapper  border-t border-gray-700 scroll-mt-16 bg-left bg-no-repeat dark:bg-none ${theme==="light" ? "text-black bg-slate-50": "text-white bg-slate-900"}   lg:bg-shape2_filpped`}>
        <div className="container relative space-y-14">
          <div className="w-full text-center">
            <div className="flex h-full w-full items-center justify-center">
              <div className="opacity: 1; transform: none;"></div>

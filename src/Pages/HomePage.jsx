    ...
    <div className=" my-4 container">
      ...
      >
        ...
        <div className="col-span-5 flex flex-col justify-center items-center">
          ...
          <p className={`${theme==="light" ? "text-black": "text-white"}  text-xl mt-6 text-left sm:ml-20`}>
          ...
          <div className="w-[100%] hidden mt-10">
            <div className="bg-coching-text_color flex h-10 p-1 items-center rounded">
              <input
                ...
                className="flex grow bg-coching-nav_color items-center p-2 h-[100%] outline-none "
              />
          ...
          <div className="mt-8 sm:ml-[-100px]">
            <div className="flex items-center">
              ...
              <p className={`${theme==="light" ? "text-black": "text-white"} text-md text-left`}>
      ...
      <section id="Feedback" className="divide-y-4 divide-green-200">
        ...
        <div className="grid sm:grid-cols-12 mt-10">
          ...
          <div className="col-span-5 mt-10 flex flex-col justify-center">
            <h2 className={`${theme==="light" ? "text-black": "text-violet-100"} text-3xl  font-bold sm:mb-3`}>
              Our Students Are
              <span className="text-coching-text_color"> Our Strength </span>See
              What They Say About Us.
            </h2>
            <p className={`${theme==="light" ? "text-black": "text-violet-100"}`}>
      ...
      {/* <section className="flex flex-col justify-center items-center gap-4">
        <span className="mt-5 mb-5 text-4xl font-bold  divide-y divide-cyan-100">
          FAQ
        </span>
        <div

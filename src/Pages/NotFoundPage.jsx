...
const CustomReact = () => {
  return (
    <div className="h-[100vh] bg-slate-900 items-center flex justify-center px-5 lg:px-0">
      <div className="w-[415px] text-center flex-col items-center justify-center mx-auto gap-[100px]">
        ...
        <div>
          <h3 className="text-4xl md:text-[56px] leading-[64px] text-[#edeeeb]">
            Page Not Found
          </h3>
        </div>
        <div className="flex flex-col gap-6 mt-3">
          <div className="text-center">
            <p className="text-base leading-6 tracking-wider text-[#edeeeb] font-sans">
